  ...
  return (
    <div>
      ...
      >
        ...
        {streaming && <span className="animate-pulse text-2xs">…</span>}
      ...
      {open && (
        <pre
          className={cn(
            "max-h-72 overflow-auto whitespace-pre-wrap break-words px-2 pb-2 pt-1 font-mono text-xs leading-relaxed text-muted-foreground",
          )}
        >
          {text}
        </pre>
