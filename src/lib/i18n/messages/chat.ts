...
export const chat = {
  en: {
    ...
    // @-mention menu (functions, automations, artifacts, files, chats)
    "mention.tab.all": "All",
    "mention.tab.functions": "Functions",
    "mention.tab.automations": "Automations",
    "mention.tab.artifacts": "Artifacts",
    "mention.tab.files": "Files",
    "mention.tab.conversations": "Chats",
    "mention.tabHint": "Tab to switch",
    "mention.empty": "No matches",
    "mention.searching": "Searching…",
    "mention.archived": "Archived",
    "mention.folder": "Folder",
    "mention.currentChat": "This chat",
    // Composer
    ...
    "workspacePanel.resize": "Resize panel",
    ...
    "workspacePanel.unsaved": "Unsaved changes",
    "workspacePanel.saved": "Saved",
    "workspacePanel.save": "Save",
    "workspacePanel.saving": "Saving…",
    "workspacePanel.editFile": "Edit {path}",
    "workspacePanel.reload": "Reload",
    "workspacePanel.confirmReload": "Discard unsaved changes and reload this file from disk?",
    "workspacePanel.tooLargeToEdit": "This file exceeds the 1 MB editing limit.",
  ...
  zh: {
    ...
    "mention.tabHint": "按 Tab 切换",
    "mention.empty": "没有匹配项",
    "mention.searching": "搜索中……",
    "mention.archived": "已归档",
    "mention.folder": "文件夹",
    "mention.currentChat": "当前会话",
    ...
    "workspacePanel.unsaved": "未保存的更改",
    "workspacePanel.saved": "已保存",
    "workspacePanel.save": "保存",
    "workspacePanel.saving": "保存中…",
    "workspacePanel.editFile": "编辑 {path}",
    "workspacePanel.reload": "重新加载",
    "workspacePanel.confirmReload": "放弃未保存的更改，从磁盘重新加载此文件？",
    "workspacePanel.tooLargeToEdit": "此文件超过 1 MB 编辑上限。",
