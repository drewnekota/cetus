...
export const meeting = {
  en: {
    ...
    "status.cloud": "SeedASR cloud",
    "status.local": "Apple on-device",
    "action.start": "Start capture now",
    "action.stop": "Stop & save",
    "ready.title": "Ready for your next conversation",
    "ready.description": "Start a note manually or use {hotkey} from anywhere.",
  ...
  zh: {
    ...
    "status.cloud": "SeedASR 云端",
    "status.local": "Apple 本地",
    "action.start": "立即开始记录",
    "action.stop": "停止并保存",
    "ready.title": "准备记录下一次对话",
    "ready.description": "手动开始，或在任意位置按 {hotkey}。",
    "enable.label": "启用会议记忆",
    ...
    "transcript.live": "实时逐字稿",
    "transcript.search": "搜索逐字稿",
    "transcript.copy": "复制全部",
