...
export const settings = {
  en: {
    ...
    "models.model.visionHint": "Turn on Vision for models that accept images — attachments are sent directly to the model.",
  ...
  zh: {
    ...
    "models.model.visionHint": "支持图片输入的模型请打开“视觉”——附件将直接发给模型。",
