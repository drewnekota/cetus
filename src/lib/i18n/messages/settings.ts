...
export const settings = {
  en: {
    ...
    "onboarding.runtime.cli.description": "Use the {name} CLI already installed and signed in on this Mac.",
  ...
  zh: {
    ...
    "onboarding.runtime.cli.description": "复用这台 Mac 上已安装并登录的 {name} CLI。",
