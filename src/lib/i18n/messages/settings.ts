...
export const settings = {
  en: {
    ...
    "update.installed": "Update ready — applies on next launch.",
    ...
    "launcher.gesture.opt.doubleOpt": "Double-tap ⌥",
    ...
    "voice.triggerKey.holdDesc":
      "Hold this modifier to talk (release to insert); double-tap it for hands-free, where each sentence is inserted as you finish it — double-tap again to stop. Right-hand keys avoid clashing with normal shortcuts. Hands-free needs the Doubao engine.",
    ...
    "connectors.description":
      "Connect the agent to external tools through MCP (Model Context Protocol) servers — a local command or a remote URL. Add a server and Test it to run a real handshake and see the tools it offers. Every enabled connector's tools are loaded into the agent so it can call them like its built-ins; changes take effect in new conversations.",
    "connectors.loading": "Loading…",
    "connectors.empty": "No connectors yet",
    "connectors.count.one": "{count} connector",
    "connectors.count.other": "{count} connectors",
    "connectors.add": "Add connector",
    "connectors.disableAria": "Disable connector",
    "connectors.enableAria": "Enable connector",
    "connectors.editAria": "Edit connector",
    "connectors.removeAria": "Remove connector",
    ...
    "connectors.oauth.saveHint": "Save the connector, then expand it below and click Authorize.",
  ...
  zh: {
    ...
    "launcher.gesture.opt.doubleOpt": "双击 ⌥",
    ...
    "voice.triggerKey.holdDesc":
      "按住该修饰键说话（松开即插入）；双击进入免手持模式，每说完一句就插入一句，再双击停止。右手键不易与常规快捷键冲突。免手持需使用豆包引擎。",
    ...
    "connectors.description":
      "通过 MCP（Model Context Protocol）服务器将智能体连接到外部工具——本地命令或远程 URL。添加服务器后点击“测试”可执行一次真实握手并查看它提供的工具。每个启用的连接器的工具都会加载到智能体中，使其能像调用内置工具一样调用它们；更改在新对话中生效。",
    "connectors.loading": "加载中…",
    "connectors.empty": "暂无连接器",
    "connectors.count.one": "{count} 个连接器",
    "connectors.count.other": "{count} 个连接器",
    "connectors.add": "添加连接器",
    "connectors.disableAria": "停用连接器",
    "connectors.enableAria": "启用连接器",
    "connectors.editAria": "编辑连接器",
    "connectors.removeAria": "移除连接器",
    ...
    "connectors.oauth.saveHint": "先保存连接器，然后在下方展开它并点击 Authorize。",
  ...
  ja: {
    ...
    "launcher.gesture.opt.doubleOpt": "⌥ をダブルタップ",
    ...
    "connectors.title": "コネクタ",
    "connectors.description":
      "MCP（Model Context Protocol）サーバー — ローカルコマンドまたはリモート URL — を通じて、エージェントを外部ツールに接続します。サーバーを追加して「テスト」すると、実際のハンドシェイクを実行し、提供されるツールを確認できます。有効な各コネクタのツールはエージェントに読み込まれ、組み込みツールのように呼び出せます。変更は新しい会話から有効になります。",
    "connectors.loading": "読み込み中…",
    "connectors.empty": "まだコネクタはありません",
    "connectors.count.one": "{count} 個のコネクタ",
    "connectors.count.other": "{count} 個のコネクタ",
    "connectors.add": "コネクタを追加",
    "connectors.disableAria": "コネクタを無効化",
    "connectors.enableAria": "コネクタを有効化",
    "connectors.editAria": "コネクタを編集",
    "connectors.removeAria": "コネクタを削除",
    ...
    "connectors.oauth.saveHint": "コネクタを保存し、下で展開して Authorize をクリックします。",
  ...
  ko: {
    ...
    "launcher.gesture.opt.doubleOpt": "⌥ 두 번 누르기",
    ...
    "connectors.description":
      "MCP(Model Context Protocol) 서버 — 로컬 명령 또는 원격 URL — 를 통해 에이전트를 외부 도구에 연결합니다. 서버를 추가하고 ‘테스트’하면 실제 핸드셰이크를 실행해 제공하는 도구를 확인할 수 있습니다. 활성화된 각 커넥터의 도구는 에이전트에 로드되어 내장 도구처럼 호출할 수 있습니다. 변경 사항은 새 대화에서 적용됩니다.",
    "connectors.loading": "불러오는 중…",
    "connectors.empty": "아직 커넥터가 없습니다",
    "connectors.count.one": "커넥터 {count}개",
    "connectors.count.other": "커넥터 {count}개",
    "connectors.add": "커넥터 추가",
    "connectors.disableAria": "커넥터 비활성화",
    "connectors.enableAria": "커넥터 활성화",
    "connectors.editAria": "커넥터 편집",
    "connectors.removeAria": "커넥터 제거",
    ...
    "connectors.oauth.saveHint": "커넥터를 저장한 뒤 아래에서 펼쳐 Authorize를 클릭하세요.",
  ...
  es: {
    ...
    "launcher.gesture.opt.doubleOpt": "Pulsar ⌥ dos veces",
    ...
    "connectors.description":
      "Conecta el agente a herramientas externas mediante servidores MCP (Model Context Protocol): un comando local o una URL remota. Añade un servidor y pulsa Probar para ejecutar un handshake real y ver las herramientas que ofrece. Las herramientas de cada conector activado se cargan en el agente para que pueda invocarlas como las suyas integradas; los cambios surten efecto en las conversaciones nuevas.",
    "connectors.loading": "Cargando…",
    "connectors.empty": "Aún no hay conectores",
    "connectors.count.one": "{count} conector",
    "connectors.count.other": "{count} conectores",
    "connectors.add": "Añadir conector",
    "connectors.disableAria": "Desactivar conector",
    "connectors.enableAria": "Activar conector",
    "connectors.editAria": "Editar conector",
    "connectors.removeAria": "Eliminar conector",
    ...
    "connectors.oauth.saveHint": "Guarda el conector, luego expándelo abajo y pulsa Autorizar.",
  ...
  pt: {
    ...
    "launcher.gesture.opt.doubleOpt": "Tocar ⌥ duas vezes",
    ...
    "connectors.oauth.saveHint": "Salve o conector, depois expanda-o abaixo e clique em Autorizar.",
  ...
  fr: {
    ...
    "launcher.gesture.opt.doubleOpt": "Appuyer deux fois sur ⌥",
    ...
    "connectors.description":
      "Connectez l'agent à des outils externes via des serveurs MCP (Model Context Protocol) — une commande locale ou une URL distante. Ajoutez un serveur et utilisez Tester pour exécuter une vraie poignée de main et voir les outils qu'il propose. Les outils de chaque connecteur activé sont chargés dans l'agent pour qu'il puisse les appeler comme ses outils intégrés ; les changements prennent effet dans les nouvelles conversations.",
    "connectors.loading": "Chargement…",
    "connectors.empty": "Aucun connecteur pour l'instant",
    "connectors.count.one": "{count} connecteur",
    "connectors.count.other": "{count} connecteurs",
    "connectors.add": "Ajouter un connecteur",
    "connectors.disableAria": "Désactiver le connecteur",
    "connectors.enableAria": "Activer le connecteur",
    "connectors.editAria": "Modifier le connecteur",
    "connectors.removeAria": "Supprimer le connecteur",
    ...
    "connectors.oauth.saveHint": "Enregistrez le connecteur, puis dépliez-le ci-dessous et cliquez sur Autoriser.",
  ...
  de: {
    ...
    "launcher.gesture.opt.doubleOpt": "⌥ doppelt tippen",
    ...
    "connectors.description":
      "Verbinde den Agenten über MCP-Server (Model Context Protocol) mit externen Tools — einem lokalen Befehl oder einer entfernten URL. Füge einen Server hinzu und teste ihn, um einen echten Handshake auszuführen und die angebotenen Tools zu sehen. Die Tools jedes aktivierten Konnektors werden in den Agenten geladen, damit er sie wie seine eingebauten Tools aufrufen kann; Änderungen werden in neuen Gesprächen wirksam.",
    "connectors.loading": "Wird geladen…",
    "connectors.empty": "Noch keine Konnektoren",
    "connectors.count.one": "{count} Konnektor",
    "connectors.count.other": "{count} Konnektoren",
    "connectors.add": "Konnektor hinzufügen",
    "connectors.disableAria": "Konnektor deaktivieren",
    "connectors.enableAria": "Konnektor aktivieren",
    "connectors.editAria": "Konnektor bearbeiten",
    "connectors.removeAria": "Konnektor entfernen",
    "connectors.editor.name": "Name",
    ...
    "connectors.oauth.saveHint": "Connector speichern, unten ausklappen und auf Autorisieren klicken.",
  ...
  it: {
    ...
    "launcher.gesture.opt.doubleOpt": "Tocca due volte ⌥",
    ...
    "connectors.description":
      "Collega l'agente a strumenti esterni tramite server MCP (Model Context Protocol) — un comando locale o una URL remota. Aggiungi un server e usa Testa per eseguire un vero handshake e vedere gli strumenti che offre. Gli strumenti di ogni connettore abilitato vengono caricati nell'agente così che possa richiamarli come quelli integrati; le modifiche hanno effetto nelle nuove conversazioni.",
    "connectors.loading": "Caricamento…",
    "connectors.empty": "Ancora nessun connettore",
    "connectors.count.one": "{count} connettore",
    "connectors.count.other": "{count} connettori",
    "connectors.add": "Aggiungi connettore",
    "connectors.disableAria": "Disabilita connettore",
    "connectors.enableAria": "Abilita connettore",
    "connectors.editAria": "Modifica connettore",
    "connectors.removeAria": "Rimuovi connettore",
    "connectors.editor.name": "Nome",
    ...
    "connectors.oauth.saveHint": "Salva il connettore, poi espandilo sotto e clicca Autorizza.",
  ...
  ru: {
    ...
    "launcher.gesture.opt.doubleOpt": "Двойное нажатие ⌥",
    ...
    "connectors.description":
      "Подключайте агента к внешним инструментам через серверы MCP (Model Context Protocol) — локальную команду или удалённый URL. Добавьте сервер и нажмите «Проверить», чтобы выполнить настоящее рукопожатие и увидеть предлагаемые инструменты. Инструменты каждого включённого коннектора загружаются в агента, чтобы он мог вызывать их как встроенные; изменения вступают в силу в новых беседах.",
    "connectors.loading": "Загрузка…",
    "connectors.empty": "Пока нет коннекторов",
    "connectors.count.one": "{count} коннектор",
    "connectors.count.other": "Коннекторов: {count}",
    "connectors.add": "Добавить коннектор",
    "connectors.disableAria": "Отключить коннектор",
    "connectors.enableAria": "Включить коннектор",
    "connectors.editAria": "Редактировать коннектор",
    "connectors.removeAria": "Удалить коннектор",
    ...
    "connectors.oauth.saveHint": "Сохраните коннектор, затем разверните его ниже и нажмите «Авторизовать».",
